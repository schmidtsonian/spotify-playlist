...
declare class TimelineLite extends SimpleTimeline {
    ...
    endTime(includeRepeats?: boolean): number;
    static declareRoot(vars?: Object, omitDelayedCalls?: boolean): TimelineLite;
...
declare module 'TweenLite'    { export = TweenLite }
declare module 'TimelineLite' { export = TimelineLite  }
declare module 'TweenMax'     { export = TweenMax  }
declare module 'TimelineMax'  { export = TimelineMax }
